  ...
  <div class="container">
    ...
    <el-dialog
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
            ...
            <el-form-item label="是否删除，0正常，1删除" prop="isDelete">
              <el-input v-model="ruleForm.isDelete"></el-input>
            </el-form-item>
...
<script>
  ...
  // 接口方法  ---- 添加表格数据
  async _checkData (id) {
    let url = "/test/getDataById?id="+id
    const result = await request({
      url: url,
      method: 'post',
    })
  ...
  handleEdit(index, row) {
    ...
    this._checkData(row.id).then(res =>{
      if(res.code === 0){
          ...
          this.ruleForm = deepCopy(res.data)
          this.$nextTick(()=>{
