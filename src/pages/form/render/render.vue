  ...
  <div class="render">
    <el-form
      ...
      <template v-for="(item, index) in formData.fields">
        ...
        <!--填空题-->
        <el-form-item :label="item.title" v-if="item.type === 'text'" :key="index+'item1'">
          <el-col :span="12">
            <el-input></el-input>
          </el-col>
        </el-form-item>
        ...
        <!--时间题-->
        <el-form-item :label="item.title" v-if="item.type === 'time'" :key="index+'item2'">
          <el-date-picker
            v-model="item.value"
            type="datetime"
            placeholder="选择日期时间">
        ...
        <!--下拉题-->
        <el-form-item :label="item.title" v-if="item.type === 'select'" :key="index+'item3'">
        ...
        <!--数字输入题-->
        <el-form-item :label="`${item.title}(${item.unit})`" v-if="item.type === 'number'" :key="index+'item4'">
          <el-col :span="4">
        ...
        <!--单选题-->
        <el-form-item :label="item.title" v-if="item.type === 'radio'" :key="index+'item5'">
        ...
        <el-form-item :label="item.title" v-if="item.type === 'null'" :key="index+'item6'">
        ...
        <el-form-item :label="item.title" v-if="item.type === 'tableRadio'" :key="index+'item7'">
          <el-col :span="24">
            <table-radio :data="item"></table-radio>
          </el-col>
        </el-form-item>

        <el-form-item :label="item.title" v-if="item.type === 'table'" :key="index+'item8'">
          <el-col :span="24">
